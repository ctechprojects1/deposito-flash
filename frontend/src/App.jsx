...
const ABAS = [
  { id: "mapa", label: "Mapa do Estoque", icone: "🗺️", perm: "ver_mapa", componente: StockMap },
  { id: "movimentar", label: "Movimentação", icone: "🔄", perm: "movimentar", componente: MovementScreen },
  { id: "solicitar", label: "Nova Solicitação", icone: "📝", perm: "solicitar", componente: RequestForm },
  { id: "separar", label: "Painel do Separador", icone: "📦", perm: "separar", componente: PickerDashboard },
  { id: "contagem", label: "Contagem", icone: "✓", perm: "contar", componente: InventoryScreen },
  { id: "importar", label: "Importar Estoque", icone: "⬆️", perm: "importar", componente: ImportScreen },
  { id: "usuarios", label: "Usuários", icone: "👤", perm: "admin", componente: UsersScreen },
];
